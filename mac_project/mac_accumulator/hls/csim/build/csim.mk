...
HLS_SOURCES = ../../../../../tb_mac.cpp ../../../../../mac_accumulator.cpp
...
$(ObjDir)/tb_mac.o: ../../../../../tb_mac.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../tb_mac.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_mac.d

$(ObjDir)/mac_accumulator.o: ../../../../../mac_accumulator.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../mac_accumulator.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=mac_accumulator $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/mac_accumulator.d
