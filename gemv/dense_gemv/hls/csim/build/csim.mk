...
HLS_SOURCES = ../../../../../tb/tb_dense_gemv.cpp ../../../../../hls/dense_gemv.cpp
...
$(ObjDir)/tb_dense_gemv.o: ../../../../../tb/tb_dense_gemv.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../tb/tb_dense_gemv.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_dense_gemv.d

$(ObjDir)/dense_gemv.o: ../../../../../hls/dense_gemv.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../hls/dense_gemv.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=dense_gemv $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/dense_gemv.d
