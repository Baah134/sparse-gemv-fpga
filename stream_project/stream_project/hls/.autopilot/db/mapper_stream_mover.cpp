...
using hls::sim::Byte;
extern "C" void stream_mover(char*, char*, int);
extern "C" void apatb_stream_mover_hw(volatile void * __xlx_apatb_param_in_stream, volatile void * __xlx_apatb_param_out_stream, int __xlx_apatb_param_N) {
...
auto* sin_stream = createStream((hls::stream<char>*)__xlx_apatb_param_in_stream);
  ...
  char* __xlx_out_stream_input_buffer= new char[ap_apatb_out_stream_cap_bc];
auto* sout_stream = createStream((hls::stream<char>*)__xlx_apatb_param_out_stream);
  // DUT call
  stream_mover(sin_stream->data<char>(), sout_stream->data<char>(), __xlx_apatb_param_N);
sin_stream->transfer((hls::stream<char>*)__xlx_apatb_param_in_stream);
sout_stream->transfer((hls::stream<char>*)__xlx_apatb_param_out_stream);
}
