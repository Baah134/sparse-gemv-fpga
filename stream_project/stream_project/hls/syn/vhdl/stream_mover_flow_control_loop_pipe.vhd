...
entity stream_mover_flow_control_loop_pipe is
port (
    ap_clk             : in  std_logic;
    ap_rst             : in  std_logic;
...
end entity stream_mover_flow_control_loop_pipe;

architecture behav of stream_mover_flow_control_loop_pipe is
