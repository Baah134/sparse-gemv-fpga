...
HLS_SOURCES = ../../../../../tb/tb_stream_mover.cpp ../../../../../hls/stream_mover.cpp
...
$(ObjDir)/tb_stream_mover.o: ../../../../../tb/tb_stream_mover.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../tb/tb_stream_mover.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_stream_mover.d

$(ObjDir)/stream_mover.o: ../../../../../hls/stream_mover.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../hls/stream_mover.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel= $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/stream_mover.d
